    ...
    fun agregarProductos(option:String?){
        ...
        when(option){
            "Antojitos" -> {
                ...
                menu.add(Product("Sincronizadas",R.drawable.sincronizadas,"Tortilla de harina rellena con queso y jamon. Se sirve con lechuga, crema y guacamole Sandwich of Two four tortillas filled with ham and cheese. Served with lettuce, sour cream, and guacamole.",3.56))
                menu.add(Product("Sopes",R.drawable.sopes,"Tortilla gruesa cubierta de frijoles, tu carne favorita, lechuga, queso fresco y crema Fried thick tortilla with beans, your choice of meat, lettuce, fresh cheese, sour cream and tomatoes",5.69))
            ...
            "Combinaciones" -> {
                ...
                menu.add(Product("Burrito Pepe",R.drawable.combinationtaco,"A flour tortilla wrapped around your choice of meat with beans, lettuce, sour cream, guacamole and pico de gallo. served with a side of rice.",7.49))
            }
            "Tortas" -> {
            ...
            "Bebidas" -> {
                ...
                menu.add(Product("Charolazo",R.drawable.drinks,"",15.75))
                menu.add(Product("Charolazo con camarones",R.drawable.drinks,"",21.99))
                menu.add(Product("La mamalona",R.drawable.drinks,"",12.99))
                menu.add(Product("La mamalona con camarones",R.drawable.drinks,"",14.99))
                menu.add(Product("Cubetazo(6 cervezas)",R.drawable.drinks,"",21.99))
            }
